...
---
--- TODO
--- если есть изменения в правилах сортировки для мода, то мы должны это обозначить (например выделить имя мода желтым (типа есть изменения), а так же желтым измененный элемент),
--- а также как то организовать симуляцию сортировки еслди не нажали применить.
--- Возможно, стоит сделать систему патчинга, типа изменили правило, появился патч для мода -> правило -> действие(удалить/добавить/выбрать) -> значение
--- и по этому патчу сделать подсветку, а  симуляцию сортировки делать с учетом патча (не нужно применять изменения, что бы добавить в патч)
--- Изменить UI: 
--- выпадающие списки расположить в одну строку сверху
--- сделать четыре отдельных области (будет использовать новый объект панель со списком модов, названием панели и кастомными действиями 
--- при наведении на мод, а так же доп кнопки рядом с панелью). 
--- Области: Загрузить перед / Загрузить после / Несовместимо / Используется в
